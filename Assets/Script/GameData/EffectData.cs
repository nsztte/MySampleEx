...
namespace MySampleEx
{
    ...
    public class EffectData : BaseData
    {
        ...
        private string xmlFileName = "effectData.xml";          //세이브시 확장자 필요
        private string dataPath = "Data/effectData";            //리소스 로드 경로
        #endregion
        ...
        public void LoadData()
        {
            ...
            if(asset == null || asset.text == null) //저장된 데이터가 없음
            {
                //새로운 데이터 추가
                AddData("NewEffect");
                return;
            ...
            using (XmlTextReader reader = new XmlTextReader(new StringReader(asset.text)))  //using: 개체범위 지정, 범위 벗어나면 알아서 처분됨
            {
